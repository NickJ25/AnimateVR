...
namespace UnityEngine.EventSystems
{
    ...
    public class OVRInputModule : PointerInputModule
    {
        ...
        public Vector2 currentCursorPosition { get; private set; }
...
#region PointerEventData pool
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            if (ovrRaycaster)
            {
                ...
                // Custom Mouse position gather
                currentCursorPosition = leftData.position;
            ...
            if (physicsRaycaster)
            {
                ...
                currentSelectedObject = leftData.pointerCurrentRaycast.gameObject;
